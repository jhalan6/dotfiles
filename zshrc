...
export PATH="/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin:$HOME/shells:$HOME/bin:/usr/local/go/bin/"
...
#python资源服务器
alias pythonFTP="sudo python -m pyftpdlib -p 21"
